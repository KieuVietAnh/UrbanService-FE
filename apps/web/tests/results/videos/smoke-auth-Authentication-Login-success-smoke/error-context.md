...
- Name: smoke\auth.spec.ts >> Authentication >> Login success
- Location: tests\smoke\auth.spec.ts:18:3
...
Expected pattern: /dashboard|\/tickets|\/staff\/queue|\/provider\/tasks|\/manager\/interactions|\/admin\/audit/
Received string:  "https://urbanservice.me/login"
Timeout: 10000ms

Call log:
  - Expect "toHaveURL" with timeout 10000ms
    22 × unexpected value "https://urbanservice.me/login"

```

```yaml
- heading "UrbanMind" [level=3]
- heading "Đăng nhập UrbanMind" [level=2]
- paragraph: Kết nối cộng đồng, kiến tạo tương lai đô thị.
...
- button "Quên mật khẩu": Quên mật khẩu?
- button "Đăng nhập"
- text: HOẶC
- button "Google logo Đăng nhập với Google":
  - img "Google logo"
  - text: Đăng nhập với Google
- text: Bạn chưa có tài khoản?
- link "Đăng ký ngay":
  - /url: /register
- heading "Đăng nhập nhanh bằng tài khoản mẫu" [level=4]
- paragraph: "Mật khẩu mặc định: 123456789"
- button "Administrator"
- button "System Staff"
- button "Interaction Manager"
- button "Service Operator"
```
